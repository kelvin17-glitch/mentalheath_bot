...
from transformers import AutoTokenizer, AutoModelForSequenceClassification, AutoModelForCausalLM, StoppingCriteria, StoppingCriteriaList
import torch
import torch.nn.functional as F
import random
from collections import deque

# Declare the stopontokens class
...
# Context tracking (deque with maxlen 6 exchanges = 12 lines)
...
while True:
    ...
    # Stop words
    stop_ids = tokenizer.convert_tokens_to_ids(["###", "User:", "Chatbot:"])
